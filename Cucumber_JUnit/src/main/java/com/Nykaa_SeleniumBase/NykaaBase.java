...
public class NykaaBase {
	...
	public static WebDriver browserLaunch(String browser) {
		...
		if (browser.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\Nancy Lawrence\\JavaTraining\\Cucumber_JUnit\\Drivers\\chromedriver.exe");
			driver = new ChromeDriver();
			driver.manage().window().maximize();
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		} else if (browser.equalsIgnoreCase("edge")) {
			System.setProperty("webdriver.edge.driver",
					"C:\\Users\\Nancy Lawrence\\JavaTraining\\Cucumber_JUnit\\Drivers\\msedgedriver.exe");
	 ...
	 */
	 ...
	 public static void screenShots(String ssname) throws IOException {
			...
			File dest = new File("C:\\Users\\Nancy Lawrence\\JavaTraining\\Cucumber_JUnit\\NykaaScreenshots"+ssname+".png");
