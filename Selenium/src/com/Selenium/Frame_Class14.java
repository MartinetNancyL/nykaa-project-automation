...
public class Frame_Class14 {
	...
	public static void main(String[] args) {
		...
		//single frame- switch to Frame by name
		driver.switchTo().frame("SingleFrame");//target locator
		...
		//Nested Frame- switch to subFrame by index
		//WebElement SubFrame = driver.findElement(By.xpath("//iframe[@src='SingleFrame.html']"));
		driver.switchTo().frame(0);
		driver.findElement(By.xpath("(//input[@type='text'])[1]")).sendKeys("Nested_Frames");//2
